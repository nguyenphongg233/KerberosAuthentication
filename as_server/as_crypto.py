"""
AS Crypto: Hệ thống mã hóa của Authentication Server
...
class ASCryptoEngine:
    """Engine mã hóa của AS"""
    ...
    def encrypt_dict(data: Dict[str, Any], key: str) -> str:
        ...
        return ASCryptoEngine.encrypt(json_str, key)
    
    @staticmethod
    def decrypt_dict(ciphertext_hex: str, key: str) -> Dict[str, Any]:
        """Giải mã thành dictionary"""
        plaintext = ASCryptoEngine.decrypt(ciphertext_hex, key)
        if not plaintext:
            return {}
        try:
